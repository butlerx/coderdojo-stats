...
module.exports = () => {
  ...
  exported.nbDojosWithAtLeast3EventsHaving2attendancesVerifiedSince = require('../regular/dojosCreatingEventsAndBookedWithAtLeastNthEventsWithNthBookedUsertype')(
    '2015-01-01',
    3,
    2,
    'ninja',
