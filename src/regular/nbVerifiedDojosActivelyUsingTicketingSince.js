...
module.exports = (verifiedSince, lastDateOfPeriod, qtyEvents, userType, qtyUserType) =>
  function () {
    console.log(__filename.slice(__dirname.length + 1));
    const dojosWithRegularEventsBookedType = require('../common/dojosWithRegularEventsBookedType')(
      lastDateOfPeriod,
      qtyEvents,
      userType,
      qtyUserType
